(function(modules) {
  function webpackJsonpCallback(data) {
    var chunkIds = data[0]; // ['async']
    var moreModules = data[1]; // { module1, mudule2 }
  ...
  __webpack_require__.e = function requireEnsure(chunkId) {
    ...
    if (installedChunkData !== 0) {
      if (installedChunkData) { // 如果这个chunk正在加载
        ...
        // setup Promise in chunk cache 新建一个chunk记载中的promise
  ...
  var jsonpArray = window['webpackJsonp'] = window['webpackJsonp'] || []; // 获取缓存里未处理的chunk module
  ...
  './src/index.js':
    (function(module, exports, __webpack_require__) {
      __webpack_require__.e('async').then(__webpack_require__.t.bind(null, './src/async.js', 7)).then(res => {
